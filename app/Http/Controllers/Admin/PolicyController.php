...
class PolicyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('policy.index')->with(['status' => true, 'message' => 'Created Successfully']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('policy.index')->with(['status' => true, 'message' => 'Updated Sucessfully']);
    }
