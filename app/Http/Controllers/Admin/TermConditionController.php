...
class TermConditionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('terms.index')->with(['status' => true, 'message' => 'Created Successfully']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('terms.index')->with(['status' => true, 'message' => 'Term & Condations Updated Sucessfully']);
    }
