                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('seamoss.create') }}" method="POST" id="seamossForm">
                                    @csrf
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-12 col-lg-3 mt-2">Paste
                                            Link</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="video_link" id="video_link_input" class="form-control custom-input" />
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7 text-center">
                                            <button type="button" class="btn btn-primary"
                                                onclick="changeInputType()">ADD</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
